...
const ROUTER = require("./scbuild/UniswapV2Router02.json");
const ERC20 = require("./scbuild/ERC20.json");
const FACTORY = require("./scbuild/IUniswapV2Factory.json");
const PAIR = require("./scbuild/IUniswapV2Pair.json");
